...
## object_recognition_tod (indigo) - 0.5.5-0

The packages in the `object_recognition_tod` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --rosdistro indigo object_recognition_tod` on `Sun, 19 Apr 2015 11:57:41 -0000`
...
## object_recognition_tod (hydro) - 0.5.5-0

The packages in the `object_recognition_tod` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --track hydro --rosdistro hydro object_recognition_tod` on `Sun, 19 Apr 2015 11:55:15 -0000`
...
## object_recognition_tod (jade) - 0.5.4-0

The packages in the `object_recognition_tod` repository were released into the `jade` distro by running `/usr/bin/bloom-release --track jade --rosdistro jade object_recognition_tod` on `Wed, 15 Apr 2015 06:09:38 -0000`
...
## object_recognition_tod (indigo) - 0.5.4-0
